 ...
 */
public class VenueCulinary extends ListActivity  {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnSearch.setOnClickListener(new View.OnClickListener(){
            public void onClick(View arg0) {
                ...
                Intent search = new Intent(VenueCulinary.this, VenueCulinarySearch.class);
    ...
    final class BackgroundTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(VenueCulinary.this);
        ...
        protected void onPostExecute(String json) {
            ...
            VenueCulinary.this.adapter_listview();
        }
    }
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
               ...
               id_kul = ((TextView) view.findViewById(R.id.text_id)).getText().toString();
                ...
                Intent in = new Intent(VenueCulinary.this, CulinaryActivity.class);
                Bundle b = new Bundle();
