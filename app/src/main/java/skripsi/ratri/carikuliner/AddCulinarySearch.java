 ...
 */
public class AddCulinarySearch extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gps = new GpsService(AddCulinarySearch.this);
        ...
        urlSearch = "https://api.foursquare.com/v2/venues/search?client_id=VOWLDU5UW1MU4TK50V4GKK1315AQL5TO3LUKE2NS1ZI1HOGG&client_secret=Z0ONVIMP2TL5U2AA3O1RAFKCK2C5VYNYLMWW45R5UGLTIP2N&v=20130815&ll=" + strLatitude + "," + strLongitude+"&"+"query="+useSearch;
    ...
    final class BackgroundTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AddCulinarySearch.this);
        ...
        protected void onPostExecute(String json) {
            ...
            * */
                ...
                ListAdapter adapter =
                        new SimpleAdapter(AddCulinarySearch.this, venuesList,R.layout.add_culinary,
                ...
                lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
                        ...
                        Intent in = new Intent(AddCulinarySearch.this, AddVenue.class);
    ...
    public void search(View view){
        ...
        Intent sr=new Intent(AddCulinarySearch.this,AddCulinarySearch.class);
        Bundle s = new Bundle();
